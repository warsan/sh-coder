...
sections:
  ...
  - type: cta_section
    title: Это CTA
    subtitle: "Познав интернет,\_ (да и жизни граммульку),\_ Испортилась в \"нет\",\_ Искурилась в... \"дидюльку\",\_ \_Такой контингент -\_ Дюже нужен \"Державе\",\_ И сам результат - очевиден...\_ (По аве)."
    actions:
      - label: Подробнее
        url: /features
        style: primary
